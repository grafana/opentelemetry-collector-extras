...
processors:
  spanpruning:
    ...
    # When enabled, records bytes_received, bytes_matched, and bytes_emitted metrics
...
| `enable_bytes_metrics` | bool | false | Enable measurement of serialized trace sizes (bytes_received/bytes_matched/bytes_emitted metrics) |
